...
# @FUNCTION: mytoolchain_fetch_git_patches
# @INTERNAL
# @DESCRIPTION:
# Fetch patches from Gentoo's gcc-patches repository.
mytoolchain_fetch_git_patches() {
...
has mytoolchain_death_notice ${EBUILD_DEATH_HOOKS} || EBUILD_DEATH_HOOKS+=" mytoolchain_death_notice"
mytoolchain_death_notice() {
